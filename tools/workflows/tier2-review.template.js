export const meta = {
  name: 'tier2-review',
  version: '1.10', // gov:kit tier2-review@1.10 // gov:kit review-harness@1.10 — BOTH ids: the
  ...
  phases: [
    { title: 'Find', detail: '4 finder lenses, one wave, ≤{{FANOUT_CAP}} concurrent' },
...
// --- cap-{{FANOUT_CAP}} fan-out (inlined; workflow scripts can't import) --------------
