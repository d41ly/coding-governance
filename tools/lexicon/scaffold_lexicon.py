...
def main(argv: list[str]) -> int:
    ...
    body.append("")
    body.append("# MEASURED against this corpus at scaffold time. Shrink-only: the count may fall, never")
    body.append("# rise. A pin copied from a larger tree is either vacuous or permanently red.")
