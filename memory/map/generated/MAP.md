<!-- codebase-map@1.7 · generated by tools/codebase-map/gen_map.py — do not hand-edit; regen: python tools/codebase-map/gen_map.py --write -->
...
Inventories: gate-legs: 105 · kits: 16 · git-hooks: 3 · workflow-scripts: 6 · skill-engines: 2 · rendered-skills: 4 · gotcha-classes: 48 · guides: 7 · backlog-shards: 4 · lexicon-verbs: 23
...
| `hook destinations (every declared hook path ships)` | agent-cap |
| `hook destinations self-test` | agent-cap |
...
| `unattended arms-groups selftest` | unattended |
