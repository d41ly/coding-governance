**Serves:** diff-review TOOL-cBriefedPilot-1..22  <!-- inferred: a Tier-2 pass over the cumulative diff, 22 units per its header -->
...
`2026-08-15-review-TOOL-cBriefedPilot-1-1.md` and are not re-read here. No leg outside the unattended kit
