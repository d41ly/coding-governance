...
carried a chat instruction, not a committed standing mandate, so the very rule this build wrote does
not authorize its own landing — and `--preflight` would refuse it, correctly.
