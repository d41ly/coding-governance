...
| [TOOL-aBatchedArm-5 — the evidence-derived pooled hang bound, and the flip](spec/2026-09-13-spec-TOOL-aBatchedArm-5.md) | 3 | 2 | OPEN | rev-6 | 2026-09-14 |
| [TOOL-aBatchedArm-1 — batch the gate self-test's arms by tree state](spec/2026-09-10-spec-TOOL-aBatchedArm-1.md) | 4 | 2 | OPEN | rev-4 | 2026-09-13 |
