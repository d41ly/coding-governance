# Build brief — DEPL-aRepatriatedFork-1

**Serves:** journal DEPL-aRepatriatedFork-1

## What you are handed

The spec at `memory/builds/aRepatriatedFork/spec/2026-09-23-spec-DEPL-aRepatriatedFork-1.md` is the design, and its §8 is resolved in place: every fork carries a
