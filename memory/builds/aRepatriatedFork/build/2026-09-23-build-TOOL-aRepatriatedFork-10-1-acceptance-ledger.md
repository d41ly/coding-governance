...
- AC9 — amended rev-2 — the leg's argv run where the script is absent exits 127 with `No such file or directory` naming it; the README ships the runnable script and says the runner half is unobserved. The section 9 rev-2 line logs the change
