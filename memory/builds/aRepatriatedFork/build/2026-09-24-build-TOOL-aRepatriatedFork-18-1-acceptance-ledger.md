...
- AC9 — `bash tools/check-kit-versions.sh` — exits 0 after the descriptors changed what they ship. `govkit epoch --base f8fdd873` reads memory-tree 2.91, unattended 1.31 and kickoff-manifest 1.6 clean
