...
| 14 | `TOOL-cMendedVintage-3` | CLOSED | `check-wiring.sh`'s boundary walk can produce the empty prefix its comment declares legal |
| 15 | `TOOL-cMendedVintage-4` | CLOSED | the three settings-merge remedies resolve at the install prefix |
...
<!-- gen:build-index -->
**Build status:** CLOSED · 40 unit(s) · node c · opened 2026-09-16 · streams deployer+tooling
...
ids DEPL-cMendedVintage-26 DEPL-cMendedVintage-27 DEPL-cMendedVintage-28 DEPL-cMendedVintage-29 TOOL-cMendedVintage-1 TOOL-cMendedVintage-2 TOOL-cMendedVintage-3 TOOL-cMendedVintage-4 TOOL-cMendedVintage-5 TOOL-cMendedVintage-6 TOOL-cMendedVintage-7 TOOL-cMendedVintage-8 TOOL-cMendedVintage-9
ids TOOL-cMendedVintage-10 TOOL-cMendedVintage-11 TOOL-cMendedVintage-12 TOOL-cMendedVintage-13 TOOL-cMendedVintage-14 TOOL-cMendedVintage-15 TOOL-cMendedVintage-16 TOOL-cMendedVintage-17 TOOL-cMendedVintage-18 TOOL-cMendedVintage-19 TOOL-cMendedVintage-20
...
| [DEPL-cMendedVintage-19 — a row's role is re-resolved at every schema, so a role move is reported](spec/2026-09-16-spec-DEPL-cMendedVintage-19.md) | 30 | 2 | CLOSED | rev-3 | 2026-09-17 |
...
| [DEPL-cMendedVintage-23 — the lf-pin write is contained before the receipt path reaches the root](spec/2026-09-17-spec-DEPL-cMendedVintage-23.md) | 33 | 2 | CLOSED | rev-3 | 2026-09-17 |
| [DEPL-cMendedVintage-24 — the dirty-path refusal still excludes the row this diff taught update to write](spec/2026-09-17-spec-DEPL-cMendedVintage-24.md) | 34 | 2 | CLOSED | rev-4 | 2026-09-17 |
...
| 19 | `TOOL-cMendedVintage-10` | no |
| 20 | `DEPL-cMendedVintage-17` | no |
| 21 | `DEPL-cMendedVintage-11` | no |
| 22 | `DEPL-cMendedVintage-12` | no |
| 23 | `DEPL-cMendedVintage-13` | no |
| 24 | `DEPL-cMendedVintage-21` | no |
| 25 | `DEPL-cMendedVintage-14` | no |
| 26 | `TOOL-cMendedVintage-6` | no |
| 27 | `TOOL-cMendedVintage-7` | no |
| 28 | `TOOL-cMendedVintage-8` | no |
...
| 36 | `TOOL-cMendedVintage-11` | no |
| 37 | `DEPL-cMendedVintage-26` | no |
| 38 | `DEPL-cMendedVintage-27` | no |
| 39 | `TOOL-cMendedVintage-12` | no |
| 40 | `DEPL-cMendedVintage-28` | no |
<!-- /gen:build-order -->
