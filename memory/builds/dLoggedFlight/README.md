...
| 23 | `TOOL-dLoggedFlight-23` | CLOSED | one self-test arm holds every time-bearing token a render writes to a public source, over classes and slots read from the schema and a fixture that reaches every conditional slot |
...
| 26 | `TOOL-dLoggedFlight-26` | CLOSED | every count and value the record arms assert over a shared fixture builder is derived from what the builder placed, on row kinds the record keeps |
...
| [TOOL-dLoggedFlight-8 — the run model: every source joined into one timeline, decision ledger, conformance block and anomaly set](spec/2026-09-13-spec-TOOL-dLoggedFlight-8.md) | 8 | 2 | CLOSED | rev-20 | 2026-09-20 |
| [TOOL-dLoggedFlight-9 — the committed per-run record: a closed-schema report and its JSON twin](spec/2026-09-13-spec-TOOL-dLoggedFlight-9.md) | 9 | 2 | CLOSED | rev-13 | 2026-09-20 |
...
| [TOOL-dLoggedFlight-23 — one self-test arm holds every time-bearing token a render writes to a public source, over classes and slots read from the schema and a fixture that reaches every conditional slot](spec/2026-09-16-spec-TOOL-dLoggedFlight-23.md) | 28 | 2 | CLOSED | rev-4 | 2026-09-20 |
