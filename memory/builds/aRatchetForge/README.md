...
# KICK-aRatchetForge — kickoff-manifest ratchet (2026-07-12)

The manifest ratchet that keeps per-project kickoff manifests true + accreting. Shipped to
...
<!-- gen:build-index -->
**Build status:** CLOSED · 0 unit(s) · node a · opened 2026-07-12 · streams kickoff · ids KICK-aRatchetForge-1
