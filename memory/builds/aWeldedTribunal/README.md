...
|---|---|---|---|---|---|
| [TOOL-aWeldedTribunal-1 — one loop-header predicate, and it recognises `for await` and `do`-blocks](spec/2026-09-04-spec-TOOL-aWeldedTribunal-1.md) | 1 | 2 | OPEN | rev-3 | 2026-09-04 |
