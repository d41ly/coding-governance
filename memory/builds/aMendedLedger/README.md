...
<!-- gen:build-index -->
**Build status:** SPECCED · 1 unit(s) · node a · opened 2026-08-09 · streams tooling+playbook · ids TOOL-aMendedLedger-1

| Unit | Status | Rev | Last change |
|---|---|---|---|
| [TOOL-aMendedLedger-1 — finish the memory rework: drain the ledger, drive the merge, re-true the docs](spec/2026-08-09-spec-aMendedLedger-1.md) | SPECCED | rev-3 | 2026-08-09 |
<!-- /gen:build-index -->
