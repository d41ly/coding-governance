...
**Serves:** diff-review PLAY-dClosedLexicon-1 TOOL-dClosedLexicon-1 TOOL-dClosedLexicon-2  <!-- inferred: an M8 closing pass whose header declares streams playbook+tooling -->
