...
**Serves:** diff-review TOOL-dClosedLexicon-1  <!-- inferred: its H1 names the unit and its Subject names the commits -->
...
landing follows. **Folds:** `reviews/2026-08-16-review-TOOL-dClosedLexicon-1-2.md` (the M4 spec audit, nine
findings).
