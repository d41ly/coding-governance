# Build brief — TOOL-aWokenSentinel-17

**Serves:** journal TOOL-aWokenSentinel-17

The pass this brief was handed to builds unit 17 of `aWokenSentinel`: the driver suite reads `--status` by FIELD: one extraction helper armed on a suffixed line, and a one-line assertion armed against a two-line driver. The spec-audit round
