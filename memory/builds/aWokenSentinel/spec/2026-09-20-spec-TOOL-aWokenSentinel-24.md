...
**Status:** CLOSED · rev-2 · 2026-09-21 · node a · Tier-2 · base 830c46e8 · streams tooling · order 24

<!-- gen:spec-records -->

| Record | Kind | Also serves |
|---|---|---|
| [2026-09-20-build-TOOL-aWokenSentinel-24-1-acceptance-ledger.md](../build/2026-09-20-build-TOOL-aWokenSentinel-24-1-acceptance-ledger.md) | journal | — |
| [2026-09-20-prompt-TOOL-aWokenSentinel-24-1-build-brief.md](../prompts/2026-09-20-prompt-TOOL-aWokenSentinel-24-1-build-brief.md) | journal | — |
...
| [2026-09-21-review-TOOL-aWokenSentinel-1-diff-review-round1.md](../reviews/2026-09-21-review-TOOL-aWokenSentinel-1-diff-review-round1.md) | diff-review | TOOL-aWokenSentinel-1 TOOL-aWokenSentinel-2 TOOL-aWokenSentinel-3 TOOL-aWokenSentinel-4 TOOL-aWokenSentinel-5 TOOL-aWokenSentinel-6 TOOL-aWokenSentinel-7 TOOL-aWokenSentinel-8 TOOL-aWokenSentinel-9 TOOL-aWokenSentinel-10 TOOL-aWokenSentinel-11 TOOL-aWokenSentinel-12 TOOL-aWokenSentinel-13 TOOL-aWokenSentinel-14 TOOL-aWokenSentinel-15 TOOL-aWokenSentinel-16 TOOL-aWokenSentinel-17 TOOL-aWokenSentinel-18 TOOL-aWokenSentinel-19 TOOL-aWokenSentinel-20 TOOL-aWokenSentinel-21 TOOL-aWokenSentinel-22 TOOL-aWokenSentinel-23 TOOL-aWokenSentinel-25 TOOL-aWokenSentinel-26 TOOL-aWokenSentinel-27 TOOL-aWokenSentinel-28 |
| [2026-09-21-review-TOOL-aWokenSentinel-1-diff-review-round2.md](../reviews/2026-09-21-review-TOOL-aWokenSentinel-1-diff-review-round2.md) | diff-review | TOOL-aWokenSentinel-1 TOOL-aWokenSentinel-2 TOOL-aWokenSentinel-3 TOOL-aWokenSentinel-4 TOOL-aWokenSentinel-5 TOOL-aWokenSentinel-6 TOOL-aWokenSentinel-7 TOOL-aWokenSentinel-8 TOOL-aWokenSentinel-9 TOOL-aWokenSentinel-10 TOOL-aWokenSentinel-11 TOOL-aWokenSentinel-12 TOOL-aWokenSentinel-13 TOOL-aWokenSentinel-14 TOOL-aWokenSentinel-15 TOOL-aWokenSentinel-16 TOOL-aWokenSentinel-17 TOOL-aWokenSentinel-18 TOOL-aWokenSentinel-19 TOOL-aWokenSentinel-20 TOOL-aWokenSentinel-21 TOOL-aWokenSentinel-22 TOOL-aWokenSentinel-23 TOOL-aWokenSentinel-25 TOOL-aWokenSentinel-26 TOOL-aWokenSentinel-27 TOOL-aWokenSentinel-28 |
...
- **S1** — `build_tick_without_conf_block` in `tools/unattended/resume-tick.test.sh`, beside that
  ...
  `sed '/^CONF=/,/^\. "\$CONF"$/d'`, and asserts through the suite's `check_same` that the copy
  holds exactly two lines matching `^read_bound_key `, zero matching `^CONF=` and zero matching
...
- **S2** — Spec 13's NOTE arm (its AC2) and spec 18's refusal arm (its AC2) each stage the BLOCK
  copy by calling the helper, and neither carries an inline `sed` over the tick any longer nor its
  own `keeps both read_bound_key calls` line, which the helper's first assertion subsumes; their
...
the block and the calls below the end anchor stay. The three `check_same` lines are the artifact: they
...
| file | change |
|---|---|
| `tools/unattended/resume-tick.test.sh` | the helper beside the assertion helpers; spec 13's NOTE arm and spec 18's refusal arm re-pointed at it, their inline `sed` and their own calls-count line removed; `FLOOR_ASSERTIONS` and its derivation comment re-derived |
...
- error / empty / loading states — a missing tick path makes `sed` fail and the first `check_same` reds
  on an empty count; an anchor that moved reds the helper naming which count.
- observability — each `check_same` names the property that failed and both counts.
...
- **AC1** — When `build_tick_without_conf_block resume-tick.sh <out>` runs over the tick at the
  tip, its three `check_same` pass and the copy's `grep -c '^read_bound_key '` prints 2; over a
  tick copy whose `. "$CONF"` line reads `source "$CONF"` the calls `check_same` reds with `0`;
  over a tick copy
...
New arm: `tools/unattended/resume-tick.test.sh` · the helper's three shape assertions on every BLOCK copy, whose breaks are the re-spelled source line and the third call · `FLOOR_ASSERTIONS` rises by the net of the helper's three executed assertions less the one calls-count line each arm gave up, twice per suite run
...
- rev-2 · 2026-09-21 · S1 · S2 · §4 · §5 · AC1 · §7 · interface fold at the pass: the suite's
  assertion helper is `check_same` (`resume-tick.test.sh:39`), not `same`, so every `same` here is
  re-spelled; and each arm's own `keeps both read_bound_key calls` line is the helper's first
  assertion spelled a second time, so the arms give it up and the count lives in one place, which is
  what §1 asks for — the floor's rise is the net of three added less one removed per arm.
