...
- BU-T2 · CLOSED · TOOL-2 pre-push enforcement BUILT: .githooks/pre-push (remote-ref classify, pushed-tip precondition, GOV_GATE_CMD seam, stdin-denied gate) + pre-push.test.sh (5 cases pass) + gate-legs.json leg + .gitattributes hook LF pins + AGENTS.md note. Full suite 16 legs GREEN
