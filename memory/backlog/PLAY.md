...
- PLAY-aCandidStub-1 · CLOSED · fifteen confirmed convergence defects across the three playbook files of the day, all built at template v2.5 with the mandatory memory-tree promotion; the orphaned companion §14 became §7 behind a real stub → `builds/aCandidStub/`
