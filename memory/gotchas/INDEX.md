...
| [hookspath-resolves-into-another-checkout](hookspath-resolves-into-another-checkout.md) | class | 4 |  | core.hooksPath is repo-global and absolute, so in a multi-worktree layout every push is gated by whatever the primary tree currently has checked out |
