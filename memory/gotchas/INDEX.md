...
| [subprocess-resolves-a-different-shell](subprocess-resolves-a-different-shell.md) | class | 3 |  | Python subprocess resolving the bare name bash finds the WSL launcher, which sees another filesystem |
