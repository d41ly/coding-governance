...
> 13 terminal rows moved byte-identical out of `../backlog/TOOL.md` when the live index
> crossed its 20 KiB cap. Nothing deleted; the all-time id-collision grep still reaches them here.
